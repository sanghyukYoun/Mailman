...
function openmailSend()
    {
        ...
        openWin = window.open("../mailSend.jsp", "childForm", "width=900, height=600, resizable = no, scrollbars = no");    
    }	
    </script>
<body>
	<%
...
%>
			<button class="btn btn-primary pull-right" onclick="if(confirm('관리자 로그인이 필요합니다.'))location.href='HP_login.jsp';" type="button" >관리자 페이지로 이동</button>
<%
			}
%>
	</td>
